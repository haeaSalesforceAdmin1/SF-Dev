...
import getAffectedVehicles from '@salesforce/apex/multiVehicleCaseController.getAffectedVehicles';
import getVehicleMakes from '@salesforce/apex/multiVehicleCaseController.getVehicleMakes';
import getVehicleModels from '@salesforce/apex/multiVehicleCaseController.getVehicleModels';
import getVehicleYears from '@salesforce/apex/multiVehicleCaseController.getVehicleYears';
import getVehicleDrivetrains from '@salesforce/apex/multiVehicleCaseController.getVehicleDrivetrains';
import getVehicleFueltypes from '@salesforce/apex/multiVehicleCaseController.getVehicleFueltypes';
import getVehicleEngines from '@salesforce/apex/multiVehicleCaseController.getVehicleEngines';
import getVehicleTransmissions from '@salesforce/apex/multiVehicleCaseController.getVehicleTransmissions';
import getVehicleModelcodes from '@salesforce/apex/multiVehicleCaseController.getVehicleModelcodes';
import saveVehicles from '@salesforce/apex/multiVehicleCaseController.saveVehicles';
import deleteVehicles from '@salesforce/apex/multiVehicleCaseController.deleteVehicles';
import getVehicleUpdateOptions from '@salesforce/apex/multiVehicleCaseController.getVehicleUpdateOptions';
import deleteAllVehicles from '@salesforce/apex/multiVehicleCaseController.deleteAllVehicles';
import { getRecordNotifyChange } from 'lightning/uiRecordApi';

import INFO_BAD_DATA_LABEL from '@salesforce/label/c.INFO_BAD_DATA';

export default class MultiVehicleCase extends NavigationMixin(LightningElement) {
    ...
    retrieveVehicleDrivetrains(){
        ...
        getVehicleDrivetrains({makes: vehicleMakes, years: vehicleYears, models: vehicleModels, modelcodes: vehicleModelcodes, selectedDrivetrains: vehicleDrivetrains})
        .then(result => {
    ...
    retrieveVehicleFueltypes(){
        ...
        getVehicleFueltypes({makes: vehicleMakes, years: vehicleYears, models: vehicleModels, modelcodes: vehicleModelcodes, selectedFuelTypes: vehicleFueltypes})
        .then(result => {
            this.showSpinner = false;
    ...
    retrieveVehicleEngines(){
        ...
        getVehicleEngines({makes: vehicleMakes, years: vehicleYears, models: vehicleModels, modelcodes: vehicleModelcodes, selectedEngines: vehicleEngines})
        .then(result => {
    ...
    retrieveVehicleTransmissions(){
        ...
        let vehicleModels = Array.prototype.map.call(this.vehicleOptions.model.filter(x => x.isSelected == true), function(item) { return item.value; }).join(";");
        let vehicleModelcodes = Array.prototype.map.call(this.vehicleOptions.modelCode.filter(x => x.isSelected == true), function(item) { return item.value; }).join(";");
        let transmissions = Array.prototype.map.call(this.vehicleOptions.transmission.filter(x => x.isSelected == true), function(item) { return item.value; }).join(";");
        console.log('Vehicle Options: ');
        console.log(JSON.stringify(this.vehicleOptions));
        // Get All Vehicle Transmissions
        getVehicleTransmissions({makes: vehicleMakes, years: vehicleYears, models: vehicleModels, modelcodes: vehicleModelcodes, selectedTransmissions: transmissions})
        .then(result => {
    ...
    retrieveVehicleUpdateOptions(){
        ...
        getVehicleUpdateOptions({makes: vehicleMakes, years: vehicleYears, models: vehicleModels, drivetrains: vehicleDrivetrains, fueltypes: vehicleFueltypes, engines: vehicleEngines, transmissions: vehicleTransmissions, modelcodes: vehicleModelcodes})
        .then(result => {
    ...
    handleNewScrSaveBtn(event){
        ...
        if(isRequiredFieldValid){
            saveVehicles({caseid: this.recordId, makes: vehicleMakes, years: vehicleYears, models: vehicleModels, drivetrains: vehicleDrivetrains, fueltypes: vehicleFueltypes, engines: vehicleEngines, transmissions: vehicleTransmissions, modelcodes: vehicleModelcodes})
            .then(result => {
