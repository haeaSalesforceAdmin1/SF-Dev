...
// Importing the custom label
import dpmrFileUploadErrorMsg from '@salesforce/label/c.dpmrFileUploadErrorMsg';

const MAX_FILE_SIZE = 3072000;

export default class EvaluationDpmrHmaService extends NavigationMixin(LightningElement) {
    ...
    topicOptions = [
        ...
        { label: 'SRC Utilization', value: 'SRC Utilization' },
